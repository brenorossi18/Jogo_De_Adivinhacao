...
def jogar_forca():
    ...
    while(not enforcou == True and not acertou == True):
    ...
    if (acertou) == True:
        mensagem_do_ganhador()
    else:
        mensagem_do_perdedor(palavra_secreta)
...
def mensagem_do_perdedor(palavra_secreta):
